...
//     <ListGroup>
//       {tasks.map((task) => (
//         <ListGroup.Item key={task.id} className={`d-flex justify-content-between align-items-center ${task.completed ? 'bg-success text-white' : ''}`}>
//           <span onClick={() => dispatch(toggleCompleteTask(task.id))} style={{ cursor: 'pointer' }}>
//             {task.task}
//           </span>
//           <ButtonGroup>
//             <Button variant="warning" onClick={() => handleEditTask(task.id, task.task)}>Edit</Button>
